...
<div class="col-md-12">
    <div class="thumbnail">
        ...
        <div class="caption">
            ...
            <h4><a href="product.php">Shawarma</a></h4>
            ...
            <div class="modal fade" id="buy_me">
             ...
             <p>A popular street food in the Middle East, which originated in Turkey
                and is made of spit-roasted layers of lamb, beef, or other meat 
                that are sliced and often wrapped in or served with pita. Shawarma 
                is similar to Greek gyros, though the former is seasoned with more 
                spices and the latter with more herbs. Hummus and tahini are commonly included. 
                The yogurt sauce called tzatziki usually served with gyros is not served with shawarma. 
                French fries often accompany both dishes.</p>
        </div>
    </div>
...
<div class="col-md-3">
    <div class="thumbnail">
        ...
        <div class="caption">
        <h5 class="pull-right">Php: 85.00</h5>
