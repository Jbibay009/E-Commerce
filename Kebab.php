...
<div class="col-md-12">
    <div class="thumbnail">
        ...
        <div class="caption">
            ...
            <h4><a href="product.php">Kebab</a></h4>
            ...
            <div class="modal fade" id="buy_me">
             ...
             <p>A diverse range of grilled meat dishes, typically skewered and cooked over an open flame, 
                with variations found globally. The word "kebab" itself, originating from the Persian word 
                "kabab" meaning "fry," reflects the dish's origin in the Eastern Mediterranean or Middle East.</p>
        </div>
    </div>
